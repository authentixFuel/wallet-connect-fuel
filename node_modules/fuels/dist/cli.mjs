...
import { findBinPath as findBinPath2 } from "@fuel-ts/utils/cli-utils";
...
var configureCli = () => {
  ...
  program.command("core", "Wrapper around Fuel Core binary", {
    executableFile: findBinPath2("fuels-core", __dirname)
  });
  program.command("forc", "Wrapper around Forc binary", {
    executableFile: findBinPath2("fuels-forc", __dirname)
  });
  return program;
};
export {
