...
import type { Provider, CoinQuantity, Account } from '@fuel-ts/account';
import { ScriptTransactionRequest } from '@fuel-ts/account';
import type { AbstractAddress, AbstractContract, AbstractProgram } from '@fuel-ts/interfaces';
...
export declare class BaseInvocationScope<TReturn = any> {
     ...
     */
    getTransactionCost(options?: TransactionCostOptions): Promise<import("@fuel-ts/account").TransactionCost>;
    /**
     ...
     * @returns The current instance of the class.
     */
    addTransfer(destination: string | AbstractAddress, amount: BigNumberish, assetId: string): this;
