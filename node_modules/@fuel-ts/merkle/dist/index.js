...
function hashLeaf(data) {
  return (0, import_hasher.hash)("0x00".concat(data.slice(2)));
}
function hashNode(left, right) {
  return (0, import_hasher.hash)("0x01".concat(left.slice(2)).concat(right.slice(2)));
}
...
function hashLeaf2(key, data) {
  const value = "0x00".concat(key.slice(2)).concat((0, import_hasher2.hash)(data).slice(2));
  return [(0, import_hasher2.hash)(value), value];
}
...
var SparseMerkleTree = class {
  ...
  updateWithSideNodes(key, value, sideNodes, oldLeafHash, oldLeafData) {
    let currentHash;
    let currentData;
    this.set((0, import_hasher4.hash)(value), value);
