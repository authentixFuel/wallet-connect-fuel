...
var InputMessageCoder = class extends import_abi_coder3.Coder {
  ...
  encode(value) {
    ...
    parts.push(new import_abi_coder3.NumberCoder("u8").encode(value.witnessIndex));
    parts.push(new import_abi_coder3.BigNumberCoder("u64").encode(value.predicateGasUsed));
    parts.push(new import_abi_coder3.NumberCoder("u32").encode(data.length));
    parts.push(new import_abi_coder3.NumberCoder("u32").encode(value.predicateLength));
    parts.push(new import_abi_coder3.NumberCoder("u32").encode(value.predicateDataLength));
...
var PoliciesCoder = class extends import_abi_coder5.Coder {
  ...
  decode(data, offset, policyTypes) {
    ...
    if (policyTypes & 1 /* GasPrice */) {
      const [gasPrice, nextOffset] = new import_abi_coder5.BigNumberCoder("u64").decode(data, o);
      o = nextOffset;
...
var WitnessCoder = class extends import_abi_coder8.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder8.NumberCoder("u32").encode(value.dataLength));
  ...
  decode(data, offset) {
    let decoded;
    let o = offset;
    [decoded, o] = new import_abi_coder8.NumberCoder("u32").decode(data, o);
    const dataLength = decoded;
    [decoded, o] = new ByteArrayCoder(dataLength).decode(data, o);
...
var TransactionScriptCoder = class extends import_abi_coder9.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder9.BigNumberCoder("u64").encode(value.scriptGasLimit));
    parts.push(new import_abi_coder9.NumberCoder("u32").encode(value.scriptLength));
    parts.push(new import_abi_coder9.NumberCoder("u32").encode(value.scriptDataLength));
  ...
  decode(data, offset) {
    let decoded;
    let o = offset;
    [decoded, o] = new import_abi_coder9.BigNumberCoder("u64").decode(data, o);
...
var TransactionCreateCoder = class extends import_abi_coder9.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder9.NumberCoder("u32").encode(value.bytecodeLength));
...
var TransactionMintCoder = class extends import_abi_coder9.Coder {
  ...
  encode(value) {
    ...
    parts.push(new import_abi_coder9.BigNumberCoder("u64").encode(value.mintAmount));
